...
const sendEmail = async (options) => {
    ...
    try {
        ...
        // So it's better to fail silently(means that even if there is an error (such as failing to send an email),
        // the application does not throw an exception or terminate abruptly. Instead, it logs a message to the console and continues running.) rather than breaking the app
        console.log(
