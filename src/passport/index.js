        ...
        if (user) {
          ...
          if (!profile._json.email) {
            next(
              new ApiError(
                400,
                "User does not have a public email associated with their account. Please try another login method" //user did not let him/her github email public it is private
              ),
              null
            );
          } else {
